...
public class ProductOptionTypesAdapter extends RecyclerView.Adapter<ProductOptionTypesAdapter.ViewHolder> {
    ...
    public ProductOptionTypesAdapter(Context context, Product product) {
        mContext = context;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(mContext, android.R.layout.simple_spinner_item, getOptionValues(optionType));
